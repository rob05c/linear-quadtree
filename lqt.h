...
struct linear_quadtree_unified lqt_create_sisd(struct lqt_point* points, size_t len, 
  ...
  struct linear_quadtree_unified lqt_create_heterogeneous_mergesort(struct lqt_point* points, size_t len, 
                                                                    ord_t xstart, ord_t xend, 
                                                                    ord_t ystart, ord_t yend,
                                                                    size_t* depth, const size_t threads);

  struct linear_quadtree_unified lqt_create_heterogeneous_samplesort(struct lqt_point* points, size_t len, 
                                                                    ord_t xstart, ord_t xend, 
                                                                    ord_t ystart, ord_t yend,
                                                                    size_t* depth, const size_t threads);
